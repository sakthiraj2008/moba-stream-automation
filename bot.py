...
# ==========================================
# FAKE WEB SERVER (To pass Koyeb Health Checks)
# ==========================================
...
def run_health_server():
    # Koyeb expects web traffic on port 8000 by default
...
# ==========================================
def main():
    # 1. Start the fake web server in the background for Koyeb health checks
    threading.Thread(target=run_health_server, daemon=True).start()
    print("Fake web server started to pass Koyeb health checks...")
